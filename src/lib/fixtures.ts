...
export const FIXTURES_BY_WEEK: Record<number, Fixture[]> = {
  ...
  2: [
    fx("Arsenal", "Liverpool"),
    fx("Aston Villa", "Manchester City"),
    fx("Bournemouth", "Brighton"),
    fx("Brentford", "Sunderland"),
    fx("Chelsea", "West Ham"),
    fx("Everton", "Fulham"),
    fx("Manchester United", "Burnley"),
    fx("Newcastle", "Nottingham Forest"),
    fx("Tottenham", "Crystal Palace"),
    fx("Wolverhampton Wanderers", "Leeds United"),
  ],
  3: [
